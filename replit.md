...
Started as a bilingual (Arabic/English) digital menu for "& Co. Coffee Shop & Pop Up"; now a multi-tenant SaaS (Stage 0 foundation + Stage 1 platform admin dashboard at /sa: stats, create/edit/activate/suspend restaurants, per-restaurant settings incl. logo/cover/colors/contact, QR download):
